        ...
        <div>
            <div className='mt-6  flex flex-col gap-3 mt-2'>
                ...
                <div className='grid grid-cols-[250px_auto] max-md:grid-cols-1 -mb-14 max-md:mb-0 gap-2'>
                    ...
                    <div className='flex gap-2 flex-col'>
                        ...
                        >
                            ...
                            <p className='mt-1 font-[400] text-[var(--color-p2text)] text-xs max-md:text-xs'>
                                {year}
                            </p>
                ...
                >
                    {/* Problem Statement */}
                    {problem && (
                        <p className='text-[var(--color-p2text)] text-sm max-md:text-xs italic border-l-2 border-[var(--color-gray)] pl-3'>
                            {problem}
                        </p>
                    )}
                        ...
                        <div className='flex flex-col gap-2'>
                            {highlights.map((highlight, i) => (
                                <div key={i} className='flex gap-2 items-start'>
                                    ...
                                    <p className='text-[var(--color-p2text)] text-sm max-md:text-xs flex-1'>
                                        {highlight}
                                    </p>
                                </div>
                            ))}
                    ...
                    {contributions && contributions.length > 0 && (
                        <div className='flex flex-col gap-1'>
                            ...
                            {contributions.map((contribution, i) => (
                                <p key={i} className='text-[var(--color-p2text)] text-xs ml-4'>
                                    - {contribution}
                                </p>
                            ))}
                        </div>
                    ...
                    {/* Role */}
                    {role && (
                        <p className='text-[var(--color-p2text)] text-sm max-md:text-xs'>
                    ...
                    {/* Tech */}
                    {tech && (
                        <p className='text-[var(--color-p2text)] text-xs'>
                ...
                >
                    <p className='text-sm text-[var(--color-p2text)] max-md:text-xs mb-3'><b>Tech Stack</b></p>
                    <div className='flex'>
